...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_main2.default, null), document.getElementById('react-main'));
	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function componentWillMount() {
	      this.serverRequest = _jquery2.default.get(RT_API.root + this.postsURI, function (results) {
	        console.log(results);
	        this.setState({
	          posts: results
	        });
